...
pp1      = db.create_user('Rahul Verma',    'rahul@infra.com',        generate_password_hash('test123'),   'PP',       '')
pp2      = db.create_user('Sunita Patel',   'sunita@mining.com',      generate_password_hash('test123'),   'PP',       '')
